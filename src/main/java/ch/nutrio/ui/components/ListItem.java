...
import ch.nutrio.ui.layout.size.Wide;
...
public class ListItem extends FlexBoxLayout {
  ...
  public ListItem(String primary, String secondary, final boolean done) {
    ...
    Supplier<VaadinIcon> iconSupplier = () -> {
      if (done) {
    ...
    final Icon icon = new Icon(iconSupplier.get());
