package ch.nutrio.ui.components.navigation.bar;
...
import ch.nutrio.ui.components.navigation.tab.NaviTab;
import ch.nutrio.ui.components.navigation.tab.NaviTabs;
import ch.nutrio.ui.util.LumoStyles;
import ch.nutrio.ui.util.UIUtils;
import ch.nutrio.ui.views.content.HomeView;

import java.util.ArrayList;

import static ch.nutrio.ui.util.UIUtils.IMG_PATH;
...
//		menuIcon.addClickListener(e -> MainLayout.get().getNaviDrawer().toggle());
	...
	private void initAvatar() {
		...
		avatar.setSrc(IMG_PATH + "images/avatar.png");
