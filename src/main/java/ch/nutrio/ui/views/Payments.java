...
import ch.nutrio.backend.DummyData;
import ch.nutrio.backend.Payment;
import ch.nutrio.ui.MainLayout;
import ch.nutrio.ui.components.Badge;
import ch.nutrio.ui.components.FlexBoxLayout;
import ch.nutrio.ui.components.ListItem;
import ch.nutrio.ui.components.detailsdrawer.DetailsDrawer;
import ch.nutrio.ui.components.detailsdrawer.DetailsDrawerHeader;
import ch.nutrio.ui.components.navigation.bar.AppBar;
import ch.nutrio.ui.layout.size.Bottom;
import ch.nutrio.ui.layout.size.Horizontal;
import ch.nutrio.ui.layout.size.Top;
import ch.nutrio.ui.layout.size.Vertical;
...
import ch.nutrio.ui.util.css.WhiteSpace;
...
//		appBar.centerTabs();
	...
	private Grid createGrid() {
		...
		ComponentRenderer<Badge, Payment> badgeRenderer = new ComponentRenderer<>(
				payment -> {
					...
					Badge badge = new Badge(status.getDesc(), status.getTheme());
	...
	private Component createDetails(Payment payment) {
		ListItem status = new ListItem(payment.getStatus().getIcon(),
				payment.getStatus().getDesc(), "Status");
